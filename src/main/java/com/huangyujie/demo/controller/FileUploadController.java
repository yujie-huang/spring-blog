...
import com.huangyujie.demo.entity.ImgResult;
...
public class FileUploadController {
    ...
    public ImgResult upload(@RequestParam(value = "file") MultipartFile file) {
        ...
        try {
            ...
            String realPath = "F:\\spring\\workspace-spring-tool-suite-4-4.5.1.RELEASE\\sp3\\src\\main\\resources\\static\\uploadImges";
